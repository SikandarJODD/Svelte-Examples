...
<div>
	...
	>
        ...
        Leaving: "transition-opacity ease-linear duration-300"
          ...
          To: "opacity-0"
      -->
		<div class="{isMobileMenu ?"translate-x-0 transition ease-in-out duration-300 transform ":"-translate-x-full transition ease-in-out duration-300 transform" } fixed inset-0 bg-gray-900/80" />

		<div class="{isMobileMenu ?"translate-x-0 transition ease-in-out duration-300 transform ":"-translate-x-full transition ease-in-out duration-300 transform" } fixed inset-0 flex">
			<!--
