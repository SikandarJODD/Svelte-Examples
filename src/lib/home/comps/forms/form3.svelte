<script>
	let formData = {
		img: 'https://i.pinimg.com/564x/66/85/1b/66851b85869c406588a615b5c3a3f2bc.jpg',
		splitImg:
			'https://images.pexels.com/photos/3227984/pexels-photo-3227984.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
...
<div class="flex min-h-full">
	...
	>
		<div class="mx-auto w-full max-w-sm lg:w-96">
			<div>
				<img class="h-14 rounded-md w-auto" src={formData.img} alt="Your Company" />
	...
	<div class="relative hidden w-0 flex-1 lg:block">
		<img class="absolute inset-0 h-full w-full object-cover" src={formData.splitImg} alt="" />
	</div>
</div>
