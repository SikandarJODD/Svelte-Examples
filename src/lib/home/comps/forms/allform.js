...
export let allforms = [
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="mx-auto h-10 w-auto" src={formData.img} alt="Your Company" />
    ...
    <div class="flex min-h-full">
        ...
        >
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    <img class="h-10 w-auto" src={formData.img} alt="Your Company" />
    ...
    {
        name: 'Card Form with Social Icons',
        component: Form4,
        code: `<script>
        let formData = {
            img: 'https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600',
